class GlobalUtils {
  static String storeId = '<<Store_ID>>'; // Replace with your storeID
  static String key =
      '<<Auth_Key>>'; //Authentication Key : The Authentication Key will be supplied by Telr as part of the Mobile API setup process after you request that this integration type is enabled for your account. This should not be stored permanently within the App.
  static String framed = '1';
  static String testmode =
      '0'; // Test mode : Test mode of zero indicates a live transaction. If this is set to any other value the transaction will be treated as a test.
  ...
  static String transtype =
      'auth'; /* paypage auth Transaction type
  ...
  static String city =
      'Jeddah'; //the minimum required details for a transaction to be processed
